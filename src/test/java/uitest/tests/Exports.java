...
class Exports extends TestNgTestBase {
    ...
    public void lotNumber_RecallReport() throws InterruptedException {
        ...
        page.GetInstance(PractitionerReports.PractitionerOrderReportPage.class)
                .isFileDownloaded("Lot_Number_Recall_Report.csv");
    ...
    public void expired_LotNumber() {
        ...
        page.GetInstance(PractitionerReports.PractitionerOrderReportPage.class)
                .isFileDownloaded("Expired_lot_report_" + Variables.MyLocalDate + ".csv");
        page.GetInstance(InventoryPages.ExpiredLotNumber.class).exportFile();
        page.GetInstance(InventoryPages.ExpiredLotNumber.class)
                .assertExport("Expired_lot_report_" + Variables.MyLocalDate + ".csv");
    }
    ...
    public void thresholdReport() {
        ...
        page.GetInstance(PractitionerReports.PractitionerOrderReportPage.class)
                .isFileDownloaded("Threshold Report.csv");
